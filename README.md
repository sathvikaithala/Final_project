...
In conclusion, the data pointwe provided can be corelated in determining the increase or decrease of the housing market. We also believe there are many other data points we should look at the get a better picture. For example, viewing by zipcode instead of city, looking at polital party majority in the area, weather, etc. 
